...
parser.add_argument('--hole_min_w', type=int, default=40)
parser.add_argument('--hole_max_w', type=int, default=40)
parser.add_argument('--hole_min_h', type=int, default=40)
parser.add_argument('--hole_max_h', type=int, default=40)
